...
export default function BentoHero() {
  return (
    ...
    >
      {/* Logo painting — full bleed background */}
      <Image
        src="/logo.png"
        alt=""
        fill
      ...
      {/* Overlay — heavy at bottom/top, lighter in center so text reads */}
      <div
        aria-hidden="true"
        className="absolute inset-0"
        style={{
          background: [
            "radial-gradient(ellipse 70% 60% at 50% 50%, oklch(0.99 0.006 90 / 0.82) 0%, oklch(0.99 0.006 90 / 0.55) 55%, oklch(0.99 0.006 90 / 0.10) 100%)",
          ].join(", "),
        }}
      />
